...
Domains play a crucial role in the configuration process of your ***_<span style="color: darkblue;">Jimber SASE Platform</span>_*** settings. They provide the basis for setting up users and administrators, allowing efficient management of your network connections and changes.
...
For example, to create a user like *'k.janeway@odyssey.com'*, you must first register the *'odyssey.com'* domain. This highlights the role of domains in setting up your network.
...
> [!WARNING]
> A domain cannot be removed if there are users associated with it. Ensure to first disassociate all linked users from the domain under the [**_Users_**](/company/users/users.md) section.
