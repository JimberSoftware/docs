...
Clicking on a group’s strip opens a window with two tabs. One tab provides an overview of the group’s devices. The second tab provides an overview of the associated security rules.
...
>
>    - Comprehensive information on Policies can be found [here](/./rules/firewall-policies/firewall-policies.md)
