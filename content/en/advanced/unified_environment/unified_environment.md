...
### Step 5 — Configure Access via Service-based policy

Finally, grant access by linking the created groups (from Step 3) to the corresponding resources (from Step 4).

This is done through a service-based policy, where attributes such as group membership and resource names are mapped to access permissions.
