...
![add_server.png](/networkisolation/create_server.png =500x){ .radius-5}
...
![edit_server.png](/edit_server.png =500x){.decor-shadow .radius-5}
...
![services_jimber.png](/services_jimber.png =800x){.decor-shadow .radius-5}
...
> **Note:** Only perform if you wish to reset to factory settings. {.is-info}
...
![server online.png](/networkisolation/server_online.png =800x){.decor-shadow .radius-5}

A server offline will appear in the overview with a red dot:
![server offline.png](/networkisolation/server_offline.png  =800x){.decor-shadow .radius-5}
...
![server detail.png](/networkisolation/server_details.png  =500x){.decor-shadow .radius-5}
![server_firewall_rules.png](/networkisolation/server_firewall_rules.png  =500x){.decor-shadow .radius-5}

## Updating a server

 An update is available when a green icon is visible next to the name  ![deleting_user.png](/networkisolation//icoon_update.png ){.radius-5}.
 
 By hovering over the icon, you can see which update it refers to.
 ![update server.png](/networkisolation/updating_server.png  =500x){.decor-shadow .radius-5}
...
{.is-warning}
 ...
 Servers can be edited by clicking on the yellow pencil icon next to their name ![pencil_2.png](/pencil_2.png){.radius-5}.
  ![edit server.png](/edit_server.png =500x){.radius-5}
  
  All  options are the same as when creating a server.

## Deleting a server

Servers can be deleted by clicking on the red trash bin icon next to their name ![recycle_bin.png](/recycle_bin.png){.radius-5}.


You will receive a warning before the device is permanently deleted:
![deleting_server.png](/networkisolation/delete_server.png =500x){.decor-shadow .radius-5}
