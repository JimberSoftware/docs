...
![add_server.png](/networkisolation/create_server.png 'size:=500x')
...
![server online.png](/networkisolation/server_online.png 'size:=800x')


A server offline will appear in the overview with a red dot:

![server offline.png](/networkisolation/server_offline.png 'size:=800x')
...
![server detail.png](/networkisolation/server_details.png 'size:=500x')


![server_firewall_rules.png](/networkisolation/server_firewall_rules.png 'size:=500x')


## Updating a server

 An update is available when a green icon is visible next to the name  
![deleting_user.png](/networkisolation//icoon_update.png )
.
 
 By hovering over the icon, you can see which update it refers to.
 
![update server.png](/networkisolation/updating_server.png 'size:=500x')
...
![deleting_server.png](/networkisolation/delete_server.png 'size:=500x')
